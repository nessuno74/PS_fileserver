...
$then = (Get-Date).AddDays(-100) # The 60 is the number of days from today since the last logon.
...
# Get-ADComputer -Property Name,lastLogonDate -Filter {lastLogonDate -lt $then} | Remove-ADComputerset-exe